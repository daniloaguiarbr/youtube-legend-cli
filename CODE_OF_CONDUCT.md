...
may be reported to the maintainers via the address listed in
`Cargo.toml`. All complaints will be reviewed and investigated and
...
[covenant]: https://www.contributor-covenant.org/version/2/1/code_of_conduct.md
